...
public class Project3 {
    ...
    private void createMainFrame() {
        ...
        mainFrame.setIconImage(new ImageIcon(getClass().getResource("cards.png")).getImage());
        ...
        for (int r = 0; r < TABLEAU_ROWS; r++) {
            for (int c = 0; c < TABLEAU_COLS; c++) {
                ...
                if (suit != null && rank != null) {
                    cardFile = String.format("%s_%s.png", suit.getSymbol(), rank.getSymbol());
    ...
    private void newGame(long gameNumber) {
        ...
        consolidator.setIcon(new ImageIcon(getClass().getResource("back.png")));
        populateTableau();
    }

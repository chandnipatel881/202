...
public class Project2
{
    ...
    public Project2(){
        slotMachine = new SlotMachine(10);
        reels = new ReelAnimation[3];
        reels[0] = new ReelAnimation(300, slotMachine.getReel(0).getSymbols());
        reels[1] = new ReelAnimation(300, slotMachine.getReel(1).getSymbols());
    ...
    private void createSidebarPanel(){
        ...
        betOneLabel.setIcon(new ImageIcon(getClass().getResource("one.jpg")));
        ...
        betMaxLabel.setIcon(new ImageIcon(getClass().getResource("max.jpg")));
        ...
        resetLabel.setIcon(new ImageIcon(getClass().getResource("reset.jpg")));
        ...
        playLabel.setIcon(new ImageIcon(getClass().getResource("spin.jpg")));
    ...
    private void createMainFrame() {
        ...
        mainFrame.setIconImage(new ImageIcon(getClass().getResource("seven.jpg")).getImage());
            ...
            implements MouseListener
    {
        ...
        private Symbol showing;
        private Symbol symbols[];
        private int i;
        private boolean stopped = true;

        public ReelAnimation(int microSeconds, Symbol[] s){
            super();
